...
export default function PaymentModal({isOpen, setIsOpen, price}) {
  ...
  function closeModal() {
    ...
    const launchRazorPay = () => {
        let options = {
            key: "rzp_test_r4MwLEhCgmsKwC",
            amount: price * 100,
            currency: "INR",
            name: "Book My Show Clone",
            description: "Movie Purcharse or rental",
            image: "https://pbs.twimg.com/profile_images/1084718695836987392/pT8dY4C-.jpg",
            handler: () => {
                setIsOpen(false);
                alert("Payment Done");
            },
              ...
              <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    Click on below button to make a payment 
                  </p>
                </div>
